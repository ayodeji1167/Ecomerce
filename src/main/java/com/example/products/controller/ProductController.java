...
public class ProductController {
    ...
    public ResponseEntity<String> addNewProduct(@RequestBody ProductCompanyDto productCompanyDto) {
    ...
    public ResponseEntity<Product> updateProduct(@PathVariable int id, @RequestBody ProductCompanyDto productCompanyDto) {
